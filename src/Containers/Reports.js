...
//---------------------------------------------------------------
    render() {
        return(
            ...
            <ReportsNav/>
            <Switch>
                <Route path='/reports/basic_finances' render={() => this.props.user.transactions ? <BasicFinances info={this.props.user.transactions} periods={this.props.user.transacts_by_period}/> : <Spinner animation="border" role="status">
  ...
  <span className="sr-only">Loading...</span>
                ...
                <Route path='/reports/budget_comparison' render={() => this.props.user.transactions ? <BudgetComparison info={this.props.user} periods={this.props.user.transacts_by_period}/> : <Spinner animation="border" role="status">
  <span className="sr-only">Loading...</span>
</Spinner>}/>
